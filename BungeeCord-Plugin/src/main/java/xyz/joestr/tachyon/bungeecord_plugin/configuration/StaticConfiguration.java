    ...
    public static class Messages {
        ...
        public static class Commands {
            ...
            public static class List {
                ...
                public static BaseComponent output(Collection<ProxiedPlayer> players) {
            ...
            public static class Ping {
                ...
                public static BaseComponent[] output(int ping) {

                    return new ComponentBuilder("Dein Ping beträgt ")
                        .color(ChatColor.AQUA)
                        .append(String.valueOf(ping) + " ms")
            ...
            public static class PingOther {
                ...
                public static BaseComponent[] output(String target, int ping) {
                ...
                public static BaseComponent[] targetNotOnline(String target) {
            ...
            public static class TPA {
                ...
                public static BaseComponent[] outputForTarget(String source) {
                    ...
                    return new ComponentBuilder("")
                        ...
                        .event(
                            new HoverEvent(
                                ...
                                new ComponentBuilder("/tpaccept").color(ChatColor.WHITE).create()
                            )
                        )
                        .append(" | ")
                        .color(ChatColor.GRAY)
                        ...
                        .event(
                            new HoverEvent(
                                HoverEvent.Action.SHOW_TEXT,
                                new ComponentBuilder("/tpdeny").color(ChatColor.WHITE).create()
                            )
                        )
                        .create();
                }
                
                public static BaseComponent[] outputForSource(String target) {

                    return new ComponentBuilder("Du hast ")
                        .color(ChatColor.AQUA)
                        .append(TextComponent.fromLegacyText(target))
                        .color(ChatColor.GRAY)
                        .append(" eine TP-Anfrage geschickt.")
                        .color(ChatColor.AQUA)
                        .create();
                }
                
                public static BaseComponent[] sourceHasPendingRequest() {
                    return new ComponentBuilder("Du hast noch eine ausstehende TP-Anfrage.")
                        .color(ChatColor.RED)
                        .create();
                }
                
                public static BaseComponent[] targetHasPendingRequest(String target) {
                    return new ComponentBuilder(target)
                        .color(ChatColor.GRAY)
                        .append(" hat noch eine ausstehende TP-Anfrage.")
                        .color(ChatColor.RED)
                        .create();
                }
            }
            ...
            public static class TPAccept {
                ...
                public static BaseComponent[] successForSource(String target) {

                    return new ComponentBuilder("Du wurdest zu ")
                ...
                public static BaseComponent[] successForTarget(String source) {

                    return new ComponentBuilder(source)
                        .color(ChatColor.GRAY)
                        .append(" wurde zu dir teleportiert.")
                        .color(ChatColor.GREEN)
                        .create();
                }

                public static BaseComponent[] noRequest() {
                ...
                public static BaseComponent[] validityExpired() {
                ...
                public static BaseComponent[] sourceOrTargetOffline(String sourceOrTarget) {

                    return new ComponentBuilder(sourceOrTarget)
                        .color(ChatColor.GRAY)
                        .append(" ist nicht online.")
                        .color(ChatColor.RED)
                        .create();
